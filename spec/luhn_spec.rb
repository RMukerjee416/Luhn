...
RSpec.describe Luhn, type: :model do
	describe 'is_valid? should work' do
		...
		# these tests confirm the code starting on the right side, not the left
		...
		it 'should return false if the number is invalid and the number has an odd number of digits' do
